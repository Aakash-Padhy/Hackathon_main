...
const StyledButton4 = withStyles({
  root: {
    background: 'linear-gradient(45deg, #2e2f33 50%, #a5a7b1 90%)',
    borderRadius: 15,
    border: 0,
    color: 'white',
    height: 48,
  ...
  return (
    ...
    <div class="container2">
      ...
      <div class="row" className="text-center ">
        <h4 className="text-center mt-5 mb-3">
          Keeping your mind healthy is as important as keeping your body healthy.<br/>
          To know more about mental health :<br/>    
          <StyledButton4 className="ml-3" 
            onClick={(e) => {
            e.preventDefault();
      ...
      <CardActionArea>
        <CardMedia >
          <img className="image" src={image4} width='60' height='60' />
            
        </CardMedia>
        <CardContent>
          <Typography className="text-center"  gutterBottom variant="h6" component="h6">
      ...
      <CardActionArea>
        <CardMedia >
          <img className="image" src={image3} width='60' height='60' />
      ...
      <CardActionArea>
        <CardMedia >
          <img className="image" src={image1} width='60' height='60' />
      ...
      <CardActionArea>
        <CardMedia >
          <img className="image" src={image2} width='60' height='60' />
